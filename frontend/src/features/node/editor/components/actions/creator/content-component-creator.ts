...
export const nodeLabelsForCreation = [
	...
	{ title: NodeLabel.subtopic, type: NodeType.subtopic ,IconNode: CircleDashedIcon },
	{ title: NodeLabel.paragraph, type: NodeType.paragraph ,IconNode: PilcrowIcon },
	...
	{ title: NodeLabel.checklist, type: NodeType.checklist ,IconNode: ListChecksIcon },
];
