...
interface TipTapEditorVideoCourseProps {
	value: string;
	onChange: (value: string) => void;
}

export const TipTapEditorVideoCourse = ({ value, onChange }: TipTapEditorVideoCourseProps) => {
	...
	return (
		<div className="border relative rounded-md overflow-hidden pb-3">
			...
			>
				<EditorContent
					editor={editor}
					className="outline-none w-full max-w-[700px] mx-auto px-4 py-3 overflow-auto prose dark:prose-invert"
				/>
			</div>
		</div>
	);
